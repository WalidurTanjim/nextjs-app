                        ...
                        <Menu as="div" className="relative ml-3">
                            ...
                            >
                                <MenuItem>
                                    <Link
                                        href="/my-profile"
                                        className="block px-4 py-2 text-sm text-gray-700 data-focus:bg-gray-100 data-focus:outline-hidden rounded-t-md"
                                    >
                                        Your Profile
                                    </Link>
                                </MenuItem>
                                ...
                                <MenuItem>
                                    <p
                                        className="block px-4 py-2 text-sm text-gray-700 data-focus:bg-gray-100 data-focus:outline-hidden rounded-b-md"
                                    >
                                        Sign out
                                    </p>
                                </MenuItem>
                    ...
                    {navigation.map((item) => (
                        <Link href={item.href} className="w-full">
                            <DisclosureButton
                                ...
                                className={classNames(
                                    item.current ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
                                    'block rounded-md px-3 py-2 text-base font-medium w-full text-left my-2',
                                )}
                            >
                                {item.name}
                            </DisclosureButton>
